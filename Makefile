...
# Template: app
# Command: D:\Qt\5.7\mingw53_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile raycasting.pro
#############################################################################
...
Makefile: raycasting.pro ../../Qt/5.7/mingw53_32/mkspecs/win32-g++/qmake.conf ../../Qt/5.7/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile raycasting.pro
